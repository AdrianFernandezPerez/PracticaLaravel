            ...
            <div class="col-12 col-sm-10 col-lg-6 mx-auto">
                ...
                <form class="bg-white shadow rounded py-3 px-4" method="POST" action="{{route('messages.store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control bg-light shadow-sm @error('name') is-invalid @else border-0 @enderror" id="name"
                               name="name"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control bg-light shadow-sm @error('subject') is-invalid @else border-0 @enderror" name="subject"
